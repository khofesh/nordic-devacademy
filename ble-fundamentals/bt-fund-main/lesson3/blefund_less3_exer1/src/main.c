...
struct bt_conn_cb connection_callbacks = {
	// https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/zephyr/connectivity/bluetooth/api/connection_mgmt.html#c.bt_conn_cb.connected
	.connected = on_connected,
	// https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/zephyr/connectivity/bluetooth/api/connection_mgmt.html#c.bt_conn_cb.disconnected
...
static int init_button(void)
{
	...
	if (err)
	{
		LOG_INF("can't init buttons (err: %d)", err);
	}
